...
def update_settings() -> None:
    ...
    logging.error(f"CURRENT:{current_app_settings}")
    logging.error(f"LATEST: {latest_app_settings}")
    logging.error(f"APP NEW SETTINGS: {app_new_settings}")
    logging.error(f"USER NEW SETTINGS: {user_new_settings}")
    if app_new_settings or user_new_settings:
        ...
        logging.error(f"MERGED {new_settings}")
